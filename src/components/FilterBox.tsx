...
export const FilterBox = ({ 
  ...
  return (
    <div className="fixed bottom-24 left-1/2 -translate-x-1/2 z-10 flex gap-2 
                    bg-background/30 backdrop-blur-sm 
                    p-3 rounded-full border border-neon-blue/20 shadow-lg shadow-neon-blue/10
                    transition-all duration-300 ease-in-out
                    hover:bg-background/90 hover:border-neon-blue/30 hover:shadow-neon-blue/20
                    group">
      <Toggle 
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-full
                 ...
                 data-[state=on]:bg-blue-500/20 data-[state=on]:text-blue-500 
      ...
      <Toggle 
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-full
                 opacity-50 group-hover:opacity-100 transition-opacity duration-300
                 data-[state=on]:bg-red-500/20 data-[state=on]:text-red-500 
                 hover:bg-red-500/10"
